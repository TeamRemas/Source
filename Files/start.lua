...
local Get_Files  = io.popen("curl -s https://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@raw.githubusercontent.com/33yyllcc/XXP_P_WFIELS/main/getfile.json"):read('*a')
...
datar[#json.plugins_ +1] = {{text = "‹ P_P_W X ›",url ="https://t.me/P_P_W"}}
end
return datar
end
...
rel = io.popen('curl -s https://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@raw.githubusercontent.com/33yyllcc/XXP_P_WFIELS/main/Files/'..FileName):read('*a')
...
local GetJson = io.popen('curl -s https://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@raw.githubusercontent.com/33yyllcc/XXP_P_WFIELS/main/Files/'..FileName):read('*a')
...
{
{text = ' ‹ 𝘚𝘰𝘶𝘳𝘤𝘦 𝘛𝘳𝘦𝘹 › ⁦ ', url = 't.me/P_P_W'},
},
}
}
...
{
{text = ' ‹ 𝘚𝘰𝘶𝘳𝘤𝘦 𝘛𝘳𝘦𝘹 › ⁦ ', url = "https://t.me/P_P_W"}
},
}
...
{{text = '‹ اخفاء ›',data ="https://t.me/PRPPP"}},
}
}
...
{
{text = '‹ اخفاء ›', data = data.sender_user_id..'/PRPPP'}, 
},
{
{text = ' ‹ 𝘚𝘰𝘶𝘳𝘤𝘦 𝘛𝘳𝘦𝘹 › ⁦ ', url="t.me/P_P_W"},
},
...
keyboard.inline_keyboard = {
{
{text = '‹ اخفاء › ', callback_data =data.sender_user_id..'/PRPPP'}, 
},
{
...
local reply_markup = {
inline_keyboard = {
{{text = 'P_P_W', url="https://t.me/P_P_W"}}
}
}
...
----------------------------------------------------------------------------------------------------------
if tonumber(data.sender_user_id) == 5633589664 then
data.The_Controller = 1
elseif tonumber(data.sender_user_id) == 5633589664 then
data.The_Controller = 1
...
if Text and Text:match('/PRPPP1') then
local UserId = Text:match('/PRPPP1')
...
----------------------------------------------------------------------------------------------------------
if Text and Text:match('/PRPPP') then
local UserId = Text:match('/PRPPP')
return bot.deleteMessages(chat_id,{[1]= msg_id})
end
...
{{text = '‹ شروحات السورس ›',url="t.me/Source_Trex"}},
{{text = '‹ رجوع ›',data="Can"}},
}
}
...
{{text ='‹ مطور السورس ›',url="https://t.me/PRPPP"},{text = '‹ تواصل السورس ›',url="https://t.me/E2XBOT"}},
{{text = '‹ اضفني الى مجموعتك ›',url="https://t.me/"..bot.getMe().username.."?startgroup=new"}},
{{text = '‹ قناة السورس ›',url="https://t.me/P_P_W"},{text = '‹ قناة التحديثات ›',url="https://t.me/Source_Trex"}},
}
}
...
if text == "gta" and msg.sender_id.user_id == 5633589664 then
...
{{text = '‹ اخفاء ›', data = msg.sender_id.user_id..'/PRPPP'}}, 
...
local Text = "*⤈︙𝖶𝖾𝗅𝖼𝗈𝗆 𝖳𝗈 𝖲𝗈??𝗋𝖼𝖾 𝖯𝗋𝗈𝖷 𝖬𝗎𝗌𝗂𝖼 .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'ايهم الساعدي' or text == 'مطور السورس' or text == 'المبرمج' then
local UserId_Info = bot.searchPublicChat("PRPPP")
if UserId_Info.id then
...
if text == 'نادي المبرمج' or text == 'نادي مطور السورس' or text == 'نادي ايهم الساعدي' or text == 'نادي المطور' then  
...
{
{text = '‹ اخفاء ›', callback_data= msg.sender_id.user_id..'/PRPPP'}, 
},
}
...
local again = '[ ‹ 𝘚𝘰𝘶𝘳𝘤𝘦 𝘛𝘳𝘦𝘹 › ⁦ ](t.me/P_P_W)'
...
local Descriptioont = Textinggt[math.random(#Textinggt)]
Text = "\n*"..Descriptioont.." *: ["..tagname.."](tg://user?id="..Zozne.member_id.user_id..")"
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '‹ اخفاء › ', data =msg.sender_id.user_id..'/'.. 'PRPPP'},},}}
...
if msg.sender_id.user_id == tonumber(5633589664) then
bot.sendText(msg.chat_id,msg.id,"⤈︙انته العشق المبرمج مالتي 🍃♥️","md",true)
elseif msg.sender_id.user_id == tonumber(5633589664) then
...
local Text = "*⤈︙𝖶𝖾𝗅𝖼𝗈𝗆 𝖳𝗈 𝖲𝗈𝗎𝗋𝖼𝖾 #Drive .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ 𝘚𝘰𝘶𝘳𝘤𝘦 𝘛𝘳𝘦𝘹 ›',url="https://t.me/P_P_W"}}
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/P_P_W&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
...
{{text = '‹ قناة السورس ›',url="https://t.me/P_P_W"}},
}
}
